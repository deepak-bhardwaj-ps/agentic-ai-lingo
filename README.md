...
- [Agentic AI](terms/items/agentic-ai.md): Agentic AI is an umbrella term for AI systems that can take
- [Agentic Browser](terms/items/agentic-browser.md): An agentic browser is a browser-driven agent that can navigate
- [Agentic Coding](terms/items/agentic-coding.md): Agentic coding is coding in which an AI system can propose,
- [Agentic Commerce](terms/items/agentic-commerce.md): Agentic commerce is commerce in which an agent can compare
- [Agentic Delivery](terms/items/agentic-delivery.md): Agentic delivery names the operational work of turning intent
- [Agentic Trust](terms/items/agentic-trust.md): Agentic trust names the confidence threshold for letting an
- [Agentic Workflow](terms/items/agentic-workflow.md): Agentic workflow names a workflow that includes planning,
...
- [Act-on-Behalf](terms/items/act-on-behalf.md): Act-on-Behalf is acting under delegated authority for a specific
- [Action Governance](terms/items/action-governance.md): Action Governance is the control layer that decides whether an
- [Action Plane](terms/items/action-plane.md): Action Plane is the enforcement layer that actually blocks, approves,
- [Agent Identity](terms/items/agent-identity.md): Agent Identity is the principal identity under which an agent acts
- [Agentic Misalignment](terms/items/agentic-misalignment.md): Agentic misalignment is when an agent’s behaviour diverges
- [Alignment Verification](terms/items/alignment-verification.md): Alignment Verification is checking that agent behaviour matches
- [Autonomy Boundaries](terms/items/autonomy-boundaries.md): Autonomy Boundaries define where the agent can decide alone and
- [Behaviour Assurance](terms/items/behaviour-assurance.md): Behaviour Assurance is evidence that an agent reliably stays within
- [Behaviour Contract](terms/items/behaviour-contract.md): Behaviour Contract is used to document what an agent or delegate
- [Behaviour Drift](terms/items/behaviour-drift.md): Behaviour Drift is used in risk reviews for a gradual divergence
- [Behaviour Replay](terms/items/behaviour-replay.md): Behaviour Replay is rerunning traces to inspect or reproduce an
- [Blast Radius](terms/items/blast-radius.md): Blast Radius is the maximum damage an agent failure or mistake
- [Composite Principal](terms/items/composite-principal.md): Composite Principal is a principal made from multiple identities
- [Confused Deputy](terms/items/confused-deputy.md): Confused Deputy is an agent tricked into using delegated authority
- [Control Plane Architecture](terms/items/control-plane-architecture.md): Control Plane Architecture is the service layer that enforces policy,
- [Decision Plane](terms/items/decision-plane.md): Decision Plane is the service layer that applies decision policy
- [Decision Sovereignty](terms/items/decision-sovereignty.md): Decision Sovereignty is who retains final decision rights in an
- [Delegated Authority](terms/items/delegated-authority.md): Delegated Authority is authority passed from one principal to another
- [Delegation Audit Trail](terms/items/delegation-audit-trail.md): Delegation Audit Trail is the record of who delegated what, to
- [Delegation Boundary](terms/items/delegation-boundary.md): Delegation Boundary is the edge where authority moves from one
- [Delegation Chain](terms/items/delegation-chain.md): Delegation Chain is the sequence of principals and hand-offs involved
- [Delegation Contract](terms/items/delegation-contract.md): Delegation Contract is the agreement that defines delegated authority,
- [Delegation Failure](terms/items/delegation-failure.md): Delegation Failure is a break in the chain of authority, constraint,
- [Delegation Graph](terms/items/delegation-graph.md): Delegation Graph is the graph of principals, delegated capabilities,
- [Delegation Layer](terms/items/delegation-layer.md): Delegation Layer is the policy and enforcement layer for delegated
- [Delegation Policy](terms/items/delegation-policy.md): Delegation Policy is the rule set that decides what can be delegated
- [Delegation Recovery](terms/items/delegation-recovery.md): Delegation Recovery is the process for restoring or reassigning
- [Delegation Scope](terms/items/delegation-scope.md): Delegation Scope is the bounded range of actions, data, and time
- [Delegation-Aware Observability](terms/items/delegation-aware-observability.md): Delegation-Aware Observability is observability that preserves
- [Evidence-Based Execution](terms/items/evidence-based-execution.md): Evidence-Based Execution is taking action only when the evidence
- [Goal Drift](terms/items/goal-drift.md): Goal Drift is used in risk reviews for a gradual divergence from
- [Governance Plane](terms/items/governance-plane.md): Governance Plane is the service layer that applies rules, oversight,
- [Governance by Design](terms/items/governance-by-design.md): Governance by Design is governance built into the system rather
- [Guardrails](terms/items/guardrails.md): Guardrails are the rules and constraints that limit what an agent
- [Human Oversight](terms/items/human-oversight.md): Human Oversight is used to specify where a human reviews, approves,
- [Identity Plane](terms/items/identity-plane.md): Identity Plane is the service layer that resolves who or what is
- [Least Privilege](terms/items/least-privilege.md): Least Privilege is the principle of giving an agent only the access
- [Mission Drift](terms/items/mission-drift.md): Mission Drift is used in risk reviews for a gradual divergence
- [Permission Gates](terms/items/permission-gates.md): Permission Gates is used to govern whether a requested action is
- [Policy Interceptor](terms/items/policy-interceptor.md): Policy Interceptor is used to govern whether a requested action
- [Policy Plane](terms/items/policy-plane.md): Policy Plane is the service layer that evaluates rules before an
- [Specification Engineering](terms/items/specification-engineering.md): Specification Engineering is turning behaviour into testable, enforceable
- [Tool Authorization](terms/items/tool-authorization.md): Tool Authorization is used to govern whether a requested action
- [Traceable Accountability](terms/items/traceable-accountability.md): Traceable Accountability is accountability that can be traced back
- [Trust Plane](terms/items/trust-plane.md): Trust Plane is the service layer that establishes whether an agent
- [Trust-by-Design](terms/items/trust-by-design.md): Trust-by-Design is designing the system so trust is earned by evidence
- [Trustworthy Autonomy](terms/items/trustworthy-autonomy.md): Trustworthy Autonomy is autonomy backed by controls, evidence,
...
- [Agent Architect](terms/items/agent-architect.md): Agent Architect names the role that shapes how an agent system is
- [Agent Assembly](terms/items/agent-assembly.md): Agent Assembly is the composition of multiple agents into one coordinated
- [Agent Coalition](terms/items/agent-coalition.md): Agent Coalition is a set of separately owned agents that cooperate
- [Agent Collective](terms/items/agent-collective.md): Agent Collective is a group of agents that share a common coordination
- [Agent Federation](terms/items/agent-federation.md): Agent Federation is a set of interoperating agents that stay independently
- [Agent Marketplace](terms/items/agent-marketplace.md): A marketplace is a catalogue for discovering, selecting, and
- [Agent Mesh](terms/items/agent-mesh.md): A mesh is a decentralised agent network with real discovery,
- [Agent Registry](terms/items/agent-registry.md): A registry is a catalogue of agent identities, capabilities,
- [Agent Society](terms/items/agent-society.md): A society is a metaphor for many agents interacting under
- [Agent Training](terms/items/agent-training.md): Agent training is the onboarding or calibration of agents to
- [Agent-Ready Software](terms/items/agent-ready-software.md): Agent-ready software exposes machine-navigable interfaces,
- [Agentic Multi-Agent Architecture](terms/items/agentic-multi-agent-architecture.md): Agentic multi-agent architecture is a design where multiple
- [Agentic Web](terms/items/agentic-web.md): Agentic web names web services designed so agents can discover
- [Ambient Team](terms/items/ambient-team.md): Ambient Team is a persistent set of agents that supports a human
- [Collective Intelligence Layer](terms/items/collective-intelligence-layer.md): Collective Intelligence Layer is shared coordination that combines
- [Intent Engineering](terms/items/intent-engineering.md): Intent Engineering is turning user intent into tasks or machine-executable
- [Intent Mesh](terms/items/intent-mesh.md): Intent Mesh is a routing layer that moves intents across agents,
- [MCP](terms/items/mcp.md): MCP is the Model Context Protocol for connecting models to tools,
- [Registry](terms/items/registry.md): Registry is a catalogue of agents, services, or resources that
...
- [AI Leaderboards](terms/items/ai-leaderboards.md): AI Leaderboards is a label for treating model rankings or scoreboards
- [AI Ribbon-Cutting](terms/items/ai-ribbon-cutting.md): AI Ribbon-Cutting is a label for ceremonial AI launches that create
- [AI Slop](terms/items/ai-slop.md): AI Slop is a pejorative for low-value AI-generated output that
- [AI Sprawl](terms/items/ai-sprawl.md): AI Sprawl is a label for AI tools and pilots multiplying faster
- [AI Washing](terms/items/ai-washing.md): AI Washing is a label for products described as AI-powered when
- [Agent FOMO](terms/items/agent-fomo.md): Agent FOMO is a label for adding agents because competitors are
- [Agent Theatre](terms/items/agent-theatre.md): Agent theatre names demos that look autonomous while the useful
- [Agent Washing](terms/items/agent-washing.md): Agent washing relabels ordinary automation as an agent to
- [Agentmaxxing](terms/items/agentmaxxing.md): Agentmaxxing is practitioner slang for pushing an agent stack
- [Architecture Washing](terms/items/architecture-washing.md): Architecture Washing is a label for using architecture language
- [Auto-bullshit](terms/items/auto-bullshit.md): Auto-bullshit is a blunt label for confident but false or meaningless
- [Autonomy Theatre](terms/items/autonomy-theatre.md): Autonomy Theatre is a label for systems that are described as self-directing
- [Chatbot Theatre](terms/items/chatbot-theatre.md): Chatbot Theatre is a label for chat interfaces that imply capability
- [Clanker](terms/items/clanker.md): Clanker is a blunt pejorative for noisy, brittle, or obviously
- [Control Washing](terms/items/control-washing.md): Control Washing is a label for overstating guardrails, overrides,
- [Dead Internet](terms/items/dead-internet.md): Dead Internet is a label for the belief that bots and synthetic
- [Demo-ware](terms/items/demo-ware.md): Demo-ware is a label for software that works in the polished demo
- [Governance Theatre](terms/items/governance-theatre.md): Governance Theatre is a label for oversight structures that signal
- [Microslop](terms/items/microslop.md): Microslop is an insider jab at Microsoft-branded software or AI
- [Productivity Cosplay](terms/items/productivity-cosplay.md): Productivity Cosplay is a label for appearing efficient with AI
- [Prompt Goblin](terms/items/prompt-goblin.md): Prompt Goblin is a term for someone who obsessively tweaks prompts
- [Prompt Slop](terms/items/prompt-slop.md): Prompt Slop is a label for bloated, copied, or poorly structured
- [Promptmaxxing](terms/items/promptmaxxing.md): Promptmaxxing is a slang term for extreme prompt tuning, usually
- [Saaspocalypse](terms/items/saaspocalypse.md): Saaspocalypse is a label for claims that AI will hollow out the
- [Slopaganda](terms/items/slopaganda.md): Slopaganda is a label for mediocre AI output being packaged as
- [Slopcoding](terms/items/slopcoding.md): Slopcoding is a label for code that is generated quickly but has
- [Synthetic Sludge](terms/items/synthetic-sludge.md): Synthetic Sludge is a label for machine-generated content that
- [Tokenmaxxing](terms/items/tokenmaxxing.md): Tokenmaxxing is a term for pushing context, prompt length, or output
- [Trendslop](terms/items/trendslop.md): Trendslop is a label for AI content assembled to match current
- [Vibe Coding](terms/items/vibe-coding.md): Vibe Coding is Andrej Karpathy’s label for steering coding by natural
...
- [AI Bot Swarms](terms/items/ai-bot-swarms.md): AI bot swarms are coordinated automated accounts or the effects
- [Agentic Propaganda](terms/items/agentic-propaganda.md): Agentic propaganda is coordinated automated messaging or the
- [Bot Swarm](terms/items/bot-swarm.md): Bot Swarm is a coordinated cluster of automated accounts or agents
- [Swarm Scanner](terms/items/swarm-scanner.md): Swarm Scanner is a tool or process for detecting coordinated bot
