...
Delegated Authority is used when a principal grants an agent a bounded power to act on its behalf. In practice, it needs a scope, an expiry, and revocation support.
