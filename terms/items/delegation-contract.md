...
Delegation Contract concerns how an agent's authority, obligations, actions or oversight are defined and evidenced.
...
Delegation Contract is used when authority passes from a person or service to an agent, or between agents. Teams use it to record the originating principal, delegated capability, constraints, expiry, downstream propagation and revocation.
